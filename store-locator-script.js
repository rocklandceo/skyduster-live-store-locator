...
$.get(GOOGLE_SHEETS_CSV_URL, function(data) {
  ...
  // Add controls, layers, and event listeners to the map
...
// Hide the default mapbox attribution and add custom logo
...
map.on('load', function() {
  ...
  map.loadImage('https://uploads-ssl.webflow.com/63a8b8d4f3ba371ef3eca92c/64eb74f60202b90fc8998067_skydusterAsset%201map-marker.png', function(error, image) {
      ...
      // Event listeners for the individual locations
      map.on('click', 'locations', (e) => {
          const features = map.queryRenderedFeatures(e.point, {
              layers: ['locations']
          });
      ...
      // Hide info window when clicking elsewhere
      map.on('click', function(e) {
          const features = map.queryRenderedFeatures(e.point, {
              layers: ['locations']
          });
